...
using WebApplicationJokes.Data;
using WebApplicationJokes.Models;

namespace WebApplicationJokes.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View();//Not needed to add "ShowSearchForm" in the parenthesis since its written above
        }
